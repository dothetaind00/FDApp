...
import com.tai06.dothetai.fdapp.Adapter.ConfirmDateAdapter;
...
public class ConfirmDonhangActivity extends AppCompatActivity {
    ...
    private ConfirmDateAdapter confirmDateAdapter;
...
//    }
    ...
    private void SetDateAdapter(List<CTHD> list) {
        confirmDateAdapter = new ConfirmDateAdapter(list, ConfirmDonhangActivity.this);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(ConfirmDonhangActivity.this, 1, GridLayoutManager.VERTICAL, false);
        recycle_confirm.setLayoutManager(gridLayoutManager);
        recycle_confirm.setAdapter(confirmDateAdapter);
        recycle_confirm.setHasFixedSize(true);
        confirmDateAdapter.notifyDataSetChanged();
    }
    ...
    private void getDate() {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Link.URL_getDateDonhang, null, new Response.Listener<JSONArray>() {
                    @Override
...
//                    @Override
//                    public void onErrorResponse(VolleyError error) {
//                        Toast.makeText(ConfirmDonhangActivity.this, "Xảy ra lỗi", Toast.LENGTH_SHORT).show();
